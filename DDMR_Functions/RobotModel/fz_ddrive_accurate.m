...
function [zdot, tau_sat] = fz_ddrive_accurate(t, z, u, params)
    ...
    % Inputs 
    tau_max = 2.85; tau_min = -2.85; %  % Limitation on Actuator's Torque [N*m]
    ...
    v_dot =  ( ((1/r) * (tau_r + tau_l - Bw*(omega_r + omega_l) )) +A3*w^2 )/A1;
    w_dot =  ( ((L/r) * (tau_r - tau_l - Bw*(omega_r - omega_l)  )) -A3*w*v )/A2;
