...
function [zdot,tau_sat] = fz_ddrive(t, z, u, params)
    ...
    % Wheel dynamics
    domega_r = (tau_r - Bw*omega_r)/Jw; % Angular Acc. of Right Wheel [rad/s^2]
    domega_l = (tau_l - Bw*omega_l)/Jw; % Angular Acc. of Left Wheel  [rad/s^2]
